...
namespace GazaHealthCenter_2.Web.Templates;
...
public class Module : GennyModule
{
    ...
    public override void Run()
    {
        ...
        {
            { $"../GazaHealthCenter_2.Services/{shortPath}{Model}Service.cs", Scaffold("Services/Service") },
            { $"../GazaHealthCenter_2.Validators/{shortPath}{Model}Validator.cs", Scaffold("Validators/Validator") },
            { $"../GazaHealthCenter_2.Controllers/{shortPath}{Controller}.cs", Scaffold("Controllers/Controller") },
            { $"../../test/GazaHealthCenter_2.Tests/Integration/Controllers/{shortPath}{Controller}Tests.cs", Scaffold("Tests/ControllerTests") },

            { $"../GazaHealthCenter_2.Web/Views/{path}/Index.cshtml", Scaffold("Web/Index") },
            { $"../GazaHealthCenter_2.Web/Views/{path}/Create.cshtml", Scaffold("Web/Create") },
            { $"../GazaHealthCenter_2.Web/Views/{path}/Details.cshtml", Scaffold("Web/Details") },
            { $"../GazaHealthCenter_2.Web/Views/{path}/Edit.cshtml", Scaffold("Web/Edit") },
            { $"../GazaHealthCenter_2.Web/Views/{path}/Delete.cshtml", Scaffold("Web/Delete") }
        };

        foreach (String view in model.ViewProperties.Keys.Where(key => key.Length == 0 || model.Views[key] != model.Views[""]))
            results[$"../GazaHealthCenter_2.Web/Resources/Views/{path}/{Model}{view}View.json"] = Scaffold($"Resources/{view}View");

        foreach (Type type in model.EnumTypes)
            results[$"../GazaHealthCenter_2.Web/Resources/Enums/{path}/{type.Name}.json"] = Scaffold("Resources/Enum", Enum.GetNames(type));

        if (!File.Exists($"../GazaHealthCenter_2.Objects/Models/{path}/{Model}.cs") ||
            !File.Exists($"../GazaHealthCenter_2.Objects/Views/{path}/{Model}View.cs"))
            results = new Dictionary<String, GennyScaffoldingResult>
            {
                { $"../GazaHealthCenter_2.Objects/Models/{path}/{Model}.cs", Scaffold("Objects/Model") },
                { $"../GazaHealthCenter_2.Objects/Views/{path}/{Model}View.cs", Scaffold("Objects/View") }
            };
    ...
    private void AddArea()
    {
        ...
        Logger.Write("../GazaHealthCenter_2.Controllers/Area.cs - ");

        String content = File.ReadAllText("../GazaHealthCenter_2.Controllers/Area.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../GazaHealthCenter_2.Controllers/Area.cs", content);
    ...
    {
        Logger.Write("../GazaHealthCenter_2.Web/mvc.sitemap - ");
    ...
    {
        Logger.Write("../GazaHealthCenter_2.Data/Migrations/Configuration.cs - ");

        String content = File.ReadAllText("../GazaHealthCenter_2.Data/Migrations/Configuration.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../GazaHealthCenter_2.Data/Migrations/Configuration.cs", content);
    ...
    {
        Logger.Write("../GazaHealthCenter_2.Web/Views/_ViewImports.cshtml - ");

        String content = File.ReadAllText("../GazaHealthCenter_2.Web/Views/_ViewImports.cshtml");
        String[] imports = Regex.Matches(content, "@using (.+);").Select(match => match.Value).ToArray();
        String[] newImports = imports
            .Append(Area == null ? "@using GazaHealthCenter_2.Controllers;" : $"@using GazaHealthCenter_2.Controllers.{Area};")
            .Distinct()
        ...
        else
        {
            ...
            File.WriteAllText("../GazaHealthCenter_2.Web/Views/_ViewImports.cshtml", content);
    ...
    {
        Logger.Write("../../test/GazaHealthCenter_2.Tests/Helpers/ObjectsFactory.cs - ");

        String content = File.ReadAllText("../../test/GazaHealthCenter_2.Tests/Helpers/ObjectsFactory.cs");
        ModuleModel model = new(Model!, Controller!, Area);
        ...
        else
        {
            ...
            File.WriteAllText("../../test/GazaHealthCenter_2.Tests/Helpers/ObjectsFactory.cs", newContent);
    ...
    {
        Logger.Write("../../test/GazaHealthCenter_2.Tests/Unit/Data/Migrations/ConfigurationTests.cs - ");

        String content = File.ReadAllText("../../test/GazaHealthCenter_2.Tests/Unit/Data/Migrations/ConfigurationTests.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../../test/GazaHealthCenter_2.Tests/Unit/Data/Migrations/ConfigurationTests.cs", content);
    ...
    {
        Logger.Write("../../test/GazaHealthCenter_2.Tests/Helpers/TestingContext.cs - ");

        String content = File.ReadAllText("../../test/GazaHealthCenter_2.Tests/Helpers/TestingContext.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../../test/GazaHealthCenter_2.Tests/Helpers/TestingContext.cs", content);
    ...
    {
        Logger.Write($"../GazaHealthCenter_2.Web/Resources/Shared/{resource}.json - ");
