...
using GazaHealthCenter_2.Components.Logging;
using GazaHealthCenter_2.Components.Mail;
using GazaHealthCenter_2.Components.Mvc;
using GazaHealthCenter_2.Components.Security;
using GazaHealthCenter_2.Controllers;
using GazaHealthCenter_2.Data;
using GazaHealthCenter_2.Data.Migrations;
...
public class Startup
{
    ...
    public Startup(IHostEnvironment host)
    {
        ...
        Config = new ConfigurationBuilder()
            ...
            .AddEnvironmentVariables($"GazaHealthCenter_2__{host.EnvironmentName}__")
            .Build();
    }
