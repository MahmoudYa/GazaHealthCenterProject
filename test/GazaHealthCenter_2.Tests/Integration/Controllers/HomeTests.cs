...
using GazaHealthCenter_2.Controllers.Administration;
...
public class HomeTests : IDisposable
{
    ...
    public HomeTests()
    {
        ...
        controller = Substitute.ForPartsOf<Home>(new AccountService(unitOfWork, hasher), new AdvertisementService(unitOfWork));
